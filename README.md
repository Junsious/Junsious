...
[![](https://skillicons.dev/icons?i=rust,py,go,bash,powershell,css,html,git,suse,mysql,graphql,docker,postgresql,linux,neovim,&theme=dark)](https://skillicons.dev)
