...
[![](https://skillicons.dev/icons?i=rust,py,go,bash,powershell,css,html,git,mysql,graphql,docker,postgresql,linux,neovim,pycharm,microsoft_visual_studio&theme=dark)](https://skillicons.dev)
