...
[![](https://skillicons.dev/icons?i=rust,py,go,bash,powershell,css,html,git,mysql,graphql,docker,postgresql,linux,neovim,pycharm,microsoftvs&theme=dark)](https://skillicons.dev)
